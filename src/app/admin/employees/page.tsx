            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  ...
                  <p className="font-mono text-xl font-bold text-yellow-900 dark:text-yellow-100">
          ...
          {[
            ...
            },
            {
              ...
              value: loading
                ? "..."
                : allEmployees
                    .reduce((sum, e) => sum + (e.workOrdersCount || 0), 0)
                    .toString(),
              icon: Award,
            ...
            },
            {
              ...
              value: loading
                ? "..."
                : allEmployees
                    .reduce((sum, e) => sum + (e.readingsCount || 0), 0)
                    .toString(),
              icon: Activity,
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-white/10">
                    {paginatedEmployees.map((employee) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(employee.status)}`}
                          >
                            <span className="capitalize">
                              {employee.status?.replace("-", " ") || "Unknown"}
                            </span>
                          </span>
                        </td>
                        <td className="px-6 py-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <p className="text-gray-900 dark:text-white capitalize">
                      {(employeeToView.status || "active").replace("-", " ")}
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <p className="text-gray-900 dark:text-white">
                      {employeeToView.workOrdersCount || 0}
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <p className="text-gray-900 dark:text-white">
                      {employeeToView.readingsCount || 0}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md border-2 border-red-500 dark:border-red-400">
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 text-center">
                  This will deactivate the employee account. They won't be able
                  to login, but all work history will be preserved.
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {employeeToDelete.designation} - {employeeToDelete.department}
                </p>
              </div>
