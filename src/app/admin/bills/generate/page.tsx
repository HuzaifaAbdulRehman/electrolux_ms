  ...
  const handleLoadPreview = async () => {
    try {
      ...
      const response = await fetch(
        `/api/bills/preview?month=${selectedMonth}-01`,
      );
      ...
      if (result.success && result.data) {
        ...
        toast.success(
          `Preview loaded: ${result.data.summary.eligibleForGeneration} customers eligible`,
        );
      } else {
      ...
      <div className="max-w-6xl mx-auto space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Generate monthly bills for all customers at once
              </p>
            </div>
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-4 border border-gray-200 dark:border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
                ...
                <div className="bg-white dark:bg-white/5 rounded-lg p-3 border border-gray-200 dark:border-white/10 hover:border-blue-400 dark:hover:border-blue-400/50 transition-all">
                  ...
                  <p className="text-xl font-bold text-blue-600 dark:text-blue-400">
                    {previewData.eligible_for_generation}
                  </p>
                </div>
              </div>

              {/* Existing Bills Information */}
              {previewData.existing_bills &&
                previewData.existing_bills.total > 0 && (
                  <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-gray-200 dark:border-white/10 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {previewData.existing_bills.total} bills exist for{" "}
                            {selectedMonth}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4">
                      <div className="bg-yellow-500/20 backdrop-blur-sm rounded-lg p-3 border border-yellow-500/30">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {previewData.existing_bills.statusCounts.pending}
                        </p>
                      </div>
                      <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-3 border border-blue-500/30">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {previewData.existing_bills.statusCounts.issued}
                        </p>
                      </div>
                      <div className="bg-green-500/20 backdrop-blur-sm rounded-lg p-3 border border-green-500/30">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {previewData.existing_bills.statusCounts.paid}
                        </p>
                      </div>
                      <div className="bg-red-500/20 backdrop-blur-sm rounded-lg p-3 border border-red-500/30">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {previewData.existing_bills.statusCounts.overdue}
                        </p>
                      </div>
                      <div className="bg-gray-500/20 backdrop-blur-sm rounded-lg p-3 border border-gray-500/30">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                          {previewData.existing_bills.statusCounts.cancelled}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                      <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span>
                          Bills have been generated for this billing period
                        </span>
                      </div>
                      <button
                        onClick={() =>
                          window.open(
                            `/admin/bills?month=${selectedMonth}`,
                            "_blank",
                          )
                        }
                ...
                <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-lg p-4 border border-gray-200 dark:border-white/10 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-white">
                        Rs {previewData.estimated_revenue.toLocaleString()}
                      </p>
                    </div>
                  ...
                  {previewData.issues.map((issue: any, index: number) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        />
                        <div>
                          <h4 className="text-gray-900 dark:text-white font-semibold capitalize mb-1">
                            {issue.type}
                          </h4>
          ...
          <button
            ...
            disabled={
              isGenerating ||
              !previewData ||
              previewData.eligible_for_generation === 0
            }
          ...
          >
            {isGenerating ? (
              ...
              <>
                ...
                <span>
                  Generate Bills for Remaining{" "}
                  {previewData.eligible_for_generation} Customers
                </span>
              </>
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <div className="bg-white dark:bg-white/5 rounded-lg p-3 border border-gray-200 dark:border-white/10">
                ...
                <p className="text-xl font-bold text-green-600 dark:text-green-400">
                  {generationResult.billsGenerated || 0}
                </p>
              </div>
            ...
            {generationResult.details && (
              <div className="mt-4 bg-gray-50 dark:bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-200 dark:border-white/10">
                ...
                <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  {Object.entries(generationResult.details).map(
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-4 border border-gray-200 dark:border-white/10">
          ...
          <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
                1
              </div>
              <p>
                <strong>Select billing month:</strong> Choose the month for
                which you want to generate bills
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
              ...
              <p>
                <strong>Load preview:</strong> Check how many customers have
                meter readings for the selected month
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
              ...
              <p>
                <strong>Generate bills:</strong> Click the generate button to
                create bills for all eligible customers
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
              ...
              <p>
                <strong>Download report:</strong> Get a summary report of the
                generation process
              </p>
            </div>
          </div>
