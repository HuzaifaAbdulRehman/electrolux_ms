...
export default function CustomerDashboard() {
  ...
  const currentBillWithConsumption =
    currentBill && safeNumber(currentBill.unitsConsumed, 0) > 0
      ? currentBill
      : null;
  const billsWithConsumption = recentBills.filter(
    (bill: any) => safeNumber(bill.unitsConsumed, 0) > 0,
  );
  ...
  const summaryCards = [
    {
      ...
      icon: DollarSign,
      color:
        safeNumber(outstandingBalance) > 0
    ...
    {
      title: "Current Bill",
      value: currentBillWithConsumption
        ? formatCurrency(currentBillWithConsumption.totalAmount, "Rs.")
        : formatCurrency(0, "Rs."),
      change: currentBillWithConsumption?.dueDate
        ? `Due: ${safeDate(currentBillWithConsumption.dueDate)}`
        : "No bill",
      trend: "neutral",
      icon: FileText,
      color: "from-yellow-400 to-orange-500",
      description: currentBillWithConsumption
    ...
    datasets: [
      {
        ...
        data: consumptionHistory
          .map((item: any) => safeNumber(item.unitsConsumed, 0))
          .slice(-6),
    ...
    datasets: [
      {
        ...
        data: monthlyPayments
          .map((item: any) => safeNumber(item.totalPaid, 0) / 1000)
          .reverse(),
    ...
    datasets: [
      {
        ...
        data: billsWithConsumption
          .map((bill: any) => safeNumber(bill.totalAmount, 0) / 1000)
          .reverse()
          .slice(0, 6),
  ...
  const totalConsumption = consumptionHistory.reduce(
    (sum: number, item: any) => sum + safeNumber(item.unitsConsumed, 0),
    0,
  );
  const isNewCustomer =
    dashboardData?.customer?.status === "active" && totalConsumption === 0;
      ...
      <div className="space-y-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white/10 rounded-lg p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono text-gray-900 dark:text-white">
                      {dashboardData.customer.meterNumber}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-mono text-gray-900 dark:text-white">
                      {dashboardData.customer.accountNumber}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
                  ⚠️ Limited access until installation is complete. An employee
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 backdrop-blur-xl rounded-2xl p-6 border border-green-500/20">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-3">
                  Your meter has been successfully installed and your account is
                  now active.
                </p>
                <div className="bg-white/10 rounded-lg p-4 space-y-2">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white">
                      {safeDate(dashboardData.customer.connectionDate)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-900 dark:text-white font-semibold mb-1">
                        Awaiting First Meter Reading
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Your usage data, consumption statistics, and billing
                        information will be available once our team records your
                        first meter reading and generates your initial bill.
                        This typically happens within the first billing cycle.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {summaryCards.map((card, index) => (
            <div
              key={index}
              className="bg-white dark:bg-white/5 rounded-xl p-4 border border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20 transition-all"
            >
              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-3">
                ...
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {currentBillWithConsumption
                    ? formatUnits(currentBillWithConsumption.unitsConsumed)
                    : "0 kWh"}
                </p>
              </div>
            </div>
              ...
              {consumptionHistory.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center px-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-500">
                    Data will appear after your first meter reading
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="h-64">
              {monthlyPayments.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center px-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-500">
                    Payment data will appear once you receive and pay bills
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="h-64">
              {currentBillWithConsumption ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center px-4">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-500">
                    Cost breakdown will appear once your first bill is generated
                  </p>
                </div>
              )}
            </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <p className="text-gray-900 dark:text-white font-semibold">
                          {formatCurrency(bill.totalAmount, "Rs.")}
                        </p>
                      </td>
                      <td className="px-6 py-4">
                        <p className="text-gray-600 dark:text-gray-400">
                          {safeDate(bill.dueDate)}
                        </p>
                      </td>
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(bill.status)}`}
                        >
                          {bill.status === "paid" && (
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500">
                          Your bills will appear here after meter readings are
                          recorded
                        </p>
                      </div>
                    </td>
                ...
                {recentPayments.length > 0 ? (
                  recentPayments.slice(0, 5).map((payment: any) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <p className="text-gray-900 dark:text-white font-semibold">
                          {formatCurrency(payment.paymentAmount, "Rs.")}
                        </p>
                      </td>
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border capitalize ${getPaymentStatusColor(payment.paymentMethod)}`}
                        >
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500">
                          Your payment records will appear here once you make
                          payments
                        </p>
                      </div>
                    </td>
