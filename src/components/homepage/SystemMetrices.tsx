    ...
    return (
      <div className="grid grid-cols-2 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/10 animate-pulse"
          >
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      {metrics.map((metric, index) => (
        ...
        >
          <div
            className={`text-3xl font-bold bg-gradient-to-r ${metric.gradient} bg-clip-text text-transparent pb-1`}
          >
            <CountUp
              start={0}
              end={metric.value}
