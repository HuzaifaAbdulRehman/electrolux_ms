  ...
  const fetchBillAndTransactions = async () => {
    try {
      ...
      const billResponse = await fetch(
        "/api/bills?status=generated,issued&limit=100",
      );
  ...
  const handlePayment = async () => {
    try {
      ...
      if (amount > billAmount) {
        setError(
          `Payment amount cannot exceed bill amount (${formatCurrency(billAmount, "Rs.")})`,
        );
        return;
      }
        ...
        <div className="h-full flex items-center justify-center">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              {error
                ? error
                : "Once a bill is issued, it will appear here for payment."}
            </p>
            <button
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Select payment method and amount to record your bill payment
              </p>
            </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    {formatCurrency(
                      unpaidBills.reduce(
                        (sum, bill) => sum + safeNumber(bill.totalAmount, 0),
                        0,
                      ),
                      "Rs.",
                    )}
                ...
                {[
                  ...
                  <React.Fragment key={item.step}>
                    <div className="flex items-center space-x-2">
                      ...
                      <span
                        className={`hidden sm:block text-sm ${paymentStep >= item.step ? "text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
                      >
                        {item.label}
                      </span>
                    </div>
                        ...
                        {unpaidBills.length > 1 && (
                          <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                            <label className="block text-sm font-semibold text-gray-900 dark:text-white mb-2">
                              Select Bill to Pay ({unpaidBills.length} unpaid
                              bills)
                            </label>
                            <select
                            ...
                            >
                              {unpaidBills.map((bill) => (
                                <option key={bill.id} value={bill.id}>
                                  ...
                                  - Rs.{" "}
                                  {safeNumber(bill.totalAmount, 0).toFixed(2)}
                                </option>
                              ))}
                            </select>
                          </div>
                        ...
                        <div className="p-4 bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10">
                          <div className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-white/10">
                            ...
                            <span className="text-sm font-semibold text-gray-900 dark:text-white">
                              {formatUnits(
                                safeNumber(currentBill?.unitsConsumed, 0),
                              )}
                            </span>
                          </div>
                  ...
                  <>
                    ...
                    <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-5 border border-gray-200 dark:border-white/10">
                          ...
                          <button
                            ...
                            className={`relative p-4 rounded-xl border transition-all ${
                              selectedMethod === method.id
                                ...
                                : "border-gray-200 dark:border-white/10 hover:border-gray-300 dark:border-gray-300 "
                            }`}
                          >
                            {method.popular && (
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-gray-50 dark:bg-white/10 border border-gray-300 dark:border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-500 focus:outline-none focus:border-yellow-400 transition-colors"
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-50 dark:bg-white/10 border border-gray-300 dark:border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-500  focus:outline-none focus:border-yellow-400 transition-colors"
                                placeholder="Huzaifa"
                              />
                            </div>
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <input
                                    ...
                                    className="px-4 py-3 bg-gray-50 dark:bg-gray-50 dark:bg-white/10 border border-gray-300 dark:border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-500  focus:outline-none focus:border-yellow-400 transition-colors"
                                    placeholder="MM"
                                    maxLength={2}
                                  />
                                  <input
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <input
                                    ...
                                    className="w-full pr-12 px-4 py-3 bg-gray-50 dark:bg-gray-50 dark:bg-white/10 border border-gray-300 dark:border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-500  focus:outline-none focus:border-yellow-400 transition-colors"
                                    placeholder="123"
                                    maxLength={3}
                                  />
                                  <button
                                    ...
                                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600 dark:text-gray-400 hover:text-gray-900"
                                  >
                                    {showCardDetails ? (
                      ...
                      <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                        <label className="text-sm font-semibold text-gray-900 dark:text-white mb-2 flex items-center">
                      ...
                      <div className="flex space-x-4 mt-6">
                        <button
                          ...
                          className="flex-1 py-3 bg-gray-50 dark:bg-gray-50 dark:bg-white/10 backdrop-blur-sm border border-gray-300 dark:border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white hover:bg-gray-100   transition-all font-semibold"
                        >
                          Back
                        </button>
                        <button
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-xl p-4 mb-4">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-gray-900 dark:text-white font-semibold">
                            {paymentResult?.receiptNumber || "N/A"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">
                          ...
                          <span className="text-gray-900 dark:text-white font-semibold">
                            {formatCurrency(parseFloat(paymentAmount), "Rs.")}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="space-y-3">
                    {recentTransactions.length > 0 ? (
                      recentTransactions.map((transaction) => (
                        <div
                          key={transaction.id}
                          className="p-3 bg-white dark:bg-white/5 rounded-lg"
                        >
                          <div className="flex justify-between mb-1">
                            <span className="text-gray-900 dark:text-white font-medium">
                              {formatCurrency(
                                safeNumber(transaction.paymentAmount, 0),
                                "Rs.",
                              )}
                            </span>
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-600 dark:text-gray-400 text-xs">
                              {safeDate(transaction.paymentDate)}
                            </span>
