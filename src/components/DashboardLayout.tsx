...
export default function DashboardLayout({
  ...
  const getInitialConnectionStatus = () => {
    if (typeof window !== "undefined") {
      ...
      const statusFetched = localStorage.getItem(
        "customerConnectionStatusFetched",
      );
  ...
  const [hasActiveConnection, setHasActiveConnection] = useState(
      ...
      return [
        ...
        },
        {
          ...
          items: [
            {
              name: "My Bills",
              href: "/customer/view-bills",
              icon: FileText,
              description: "View & download bills",
            },
            {
              name: "Make Payment",
            ...
            },
            {
              ...
              icon: BarChart3,
              description: "Track consumption patterns",
            },
            {
              name: "Bill Calculator",
              href: "/customer/bill-calculator",
              icon: Calculator,
              description: "Estimate your bill",
            },
          ],
        },
        {
          ...
          items: [
            {
              name: "Request Reading",
              href: "/customer/request-reading",
              icon: Gauge,
            ...
            },
            {
              ...
              href: "/customer/outage-schedule",
              icon: ZapOff,
              description: "Planned power outages",
            },
          ],
        },
        {
      ...
      return [
        ...
        },
        {
          ...
          items: [
            {
              name: "Meter Reading",
              href: "/employee/meter-reading",
              icon: Gauge,
              description: "Record customer readings",
            },
            {
              name: "Work Orders",
            ...
            },
            {
              ...
              href: "/employee/bill-generation",
              icon: FileText,
              description: "Generate customer bills",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: Zap,
              description: "Review new connection applications",
            },
            {
              name: "Reading Requests",
              href: "/admin/reading-requests",
              icon: Gauge,
              description: "Manage meter reading requests",
            },
            {
            ...
            },
            {
              ...
              icon: MessageSquare,
              description: "Review & assign complaints",
            },
          ],
        },
        {
          ...
          items: [
            {
              name: "Generate Bills",
              href: "/admin/bills/generate",
              icon: FileText,
              description: "Bulk bill generation",
            },
            {
              name: "View Bills",
              href: "/admin/bills",
              icon: Eye,
              description: "View & manage generated bills",
            },
            {
              name: "Tariffs",
              href: "/admin/tariffs",
          ...
          items: [
            {
              ...
              href: "/admin/outages",
              icon: ZapOff,
              description: "Manage power outages",
            },
            {
              name: "Settings",
              href: "/admin/settings",
  ...
  const toggleTheme = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("themeChange", { detail: { isDark: newTheme } }),
    );
  };
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="px-4 py-3 border-b dark:border-gray-700">
            <span
              className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-white bg-gradient-to-r ${getUserTypeColor()}`}
            >
              {getUserTypeLabel()}
            </span>
          </div>
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        <li key={item.name}>
                          ...
                          >
                            <item.icon
                              className={`h-5 w-5 flex-shrink-0 ${isActive ? "" : "group-hover:scale-110 transition-transform"}`}
                            />
                  ...
                  <span
                    className={`flex items-center space-x-1 text-sm ${
                      connectionStatus === "active"
                        ? "text-green-500"
                        : connectionStatus === "pending_installation"
                          ? "text-yellow-500"
