...
export default function AdminCustomers() {
  ...
  const fetchCustomers = async () => {
    try {
      ...
      if (filterConnectionType !== "all")
        params.append("connectionType", filterConnectionType);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {[
            ...
            },
            {
              ...
              value: loading
                ? "..."
                : `Rs ${allCustomers.reduce((sum, c) => sum + (parseFloat(c.outstandingBalance) || 0), 0).toLocaleString()}`,
              icon: DollarSign,
            ...
            },
            {
              ...
              value: loading
                ? "..."
                : `${Math.round(allCustomers.reduce((sum, c) => sum + (parseFloat(c.averageMonthlyUsage) || 0), 0) / Math.max(allCustomers.length, 1))} kWh`,
              icon: Activity,
            ...
            <div
              key={index}
              className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-gray-200 dark:border-white/10"
            >
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="space-y-2">
                            <div>
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getConnectionTypeColor(customer.connectionType)}`}
                              >
                                {customer.connectionType}
                              </span>
                            </div>
                        ...
                        <td className="px-6 py-4">
                          <div className="space-y-2">
                            ...
                            <div>
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getPaymentStatusColor(customer.paymentStatus)}`}
                              >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(customer.status)}`}
                          >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className="p-2 text-gray-600  hover:text-gray-900 dark:text-white hover:bg-gray-50 dark:bg-white/10 rounded-lg transition-all"
                              title="View Details"
                            >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="px-3 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 bg-white  border border-gray-300 dark:border-white/20 rounded-lg hover:bg-gray-50 dark:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Previous
                      </button>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-center pt-6 border-t border-gray-200 dark:border-white/10">
                      <button
                        onClick={() =>
                          router.push(
                            `/customer/view-bills?customerId=${customer.id}`,
                          )
                        }
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                    Add New Customer (Offline Registration)
                  </h2>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    For walk-in customers - meter will be auto-assigned
                  </p>
                </div>
                <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                        CNIC must be 13 digits (formatted 5-7-1).
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-b border-gray-200 dark:border-white/10 pb-4">
                  ...
                  <div className="mb-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>Note:</strong> All connections are Single-Phase.
                      One customer can have only one meter connection.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      />
                      <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                        Enter the installation/connection charges for this
                        customer
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 border-2 border-yellow-300 dark:border-yellow-700">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(
                          createdCustomer.temporaryPassword,
                          "Password",
                        )
                      }
                  ...
                  <p className="text-lg font-mono font-bold text-yellow-900 dark:text-yellow-200">
                    {createdCustomer.temporaryPassword}
                  </p>
                ...
                {createdCustomer.status === "pending_installation" && (
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                    <p className="text-xs text-blue-800 dark:text-blue-300 flex items-start">
                      ...
                      <span>
                        Meter number will be assigned after installation by
                        employee. Customer can login but cannot view bills until
                        meter is installed.
                      </span>
                    </p>
                  </div>
              ...
              <form onSubmit={handleEditCustomer} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="pending_installation">
                ...
                <div className="flex items-center space-x-3 pt-4">
                  <button
                    ...
                    className="flex-1 px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100  rounded-lg hover:bg-gray-200 dark:bg-white/20 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md border-2 border-red-500 dark:border-red-400">
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 text-center">
                  This will deactivate the customer account. They won't be able
                  to login, but all data will be preserved.
                </p>
              </div>
