  ...
  const managementSections = [
    {
      ...
      description:
        "Configure electricity tariff rates for different customer types",
      icon: Zap,
    ...
    <DashboardLayout userType="admin" userName="Admin">
      <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Central hub for all system configuration and management
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-gray-200 dark:border-white/10">
          ...
          <div>
            <label className="text-sm text-gray-700 dark:text-gray-300 mb-3 block font-medium">
              Theme Mode
            </label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Light Theme */}
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  <div
                    className={`p-3 rounded-lg ${theme === "light" ? "bg-red-500/20" : "bg-gray-100 dark:bg-white/5"}`}
                  >
                    <Sun
                      className={`w-6 h-6 ${theme === "light" ? "text-red-500" : "text-gray-600 dark:text-gray-400"}`}
                    />
                  </div>
                  <span
                    className={`font-semibold ${theme === "light" ? "text-red-500" : "text-gray-700 dark:text-gray-300"}`}
                  >
                    Light
                  </span>
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  <div
                    className={`p-3 rounded-lg ${theme === "dark" ? "bg-red-500/20" : "bg-gray-100 dark:bg-white/5"}`}
                  >
                    <Moon
                      className={`w-6 h-6 ${theme === "dark" ? "text-red-500" : "text-gray-600 dark:text-gray-400"}`}
                    />
                  </div>
                  <span
                    className={`font-semibold ${theme === "dark" ? "text-red-500" : "text-gray-700 dark:text-gray-300"}`}
                  >
                    Dark
                  </span>
                  <span className="text-xs text-gray-500 dark:text-gray-400 text-center">
              ...
              >
                <div className="flex flex-col items-center space-y-2">
                  <div
                    className={`p-3 rounded-lg ${theme === "system" ? "bg-red-500/20" : "bg-gray-100 dark:bg-white/5"}`}
                  >
                    <Monitor
                      className={`w-6 h-6 ${theme === "system" ? "text-red-500" : "text-gray-600 dark:text-gray-400"}`}
                    />
                  </div>
                  <span
                    className={`font-semibold ${theme === "system" ? "text-red-500" : "text-gray-700 dark:text-gray-300"}`}
                  >
                    System
                  </span>
                  <span className="text-xs text-gray-500 dark:text-gray-400 text-center">
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-gray-200 dark:border-white/10">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Quick access to all system management features
          </p>
            ...
            {managementSections.slice(0, 6).map((section, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={`p-3 bg-gradient-to-br ${section.color} rounded-xl`}
                  >
