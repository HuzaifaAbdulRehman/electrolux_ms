...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      try {
        ...
        console.warn(
          "[Dashboard] Failed to cache data to localStorage:",
          cacheErr,
        );
      }
  ...
  const validRevenueEntries = Object.entries(revenueByCategory).filter(
    ([_, value]) => {
      const numValue =
  ...
  const connectionTypeData = {
    labels: connectionTypeLabels.map(
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Comprehensive overview of ElectroLux EMS
              </p>
            </div>
                      ...
                      tooltip: {
                        ...
                        callbacks: {
                          label: function (context: any) {
                            ...
                            const typeKey =
                              connectionTypeLabels[context.dataIndex];
                            const activeCount =
                              (connectionTypeDistribution[typeKey] as any)
                                ?.activeCount || 0;
                            return [
                      ...
                      tooltip: {
                        ...
                        callbacks: {
                          label: function (context: any) {
                            ...
                            const statusKey =
                              billsStatusLabels[context.dataIndex];
                            const amount =
                              (billsStatus[statusKey] as any)?.amount || 0;
                            return [
